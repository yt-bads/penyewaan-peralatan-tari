...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'edit_profil') {
        ...
        if ($nama === '') {
            ...
            try {
                $stmt = $pdo->prepare("UPDATE users SET nama = ?, no_telp = ?, alamat = ? WHERE id = ?");
                $stmt->execute([$nama, $no_telp, $alamat, $userId]);
...
<head>
    ...
    <title>Profil Saya - Sewa Tari</title>
            ...
            <div class="profile-card">
                ...
                <form action="profil.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telp" id="no_telp" class="form-control" value="<?= htmlspecialchars($profile['no_telp'] ?? '') ?>">
                    </div>

                    <div class="form-group">
                        <label for="alamat" class="form-label">Alamat Lengkap</label>
                        <textarea name="alamat" id="alamat" class="form-control" rows="3"><?= htmlspecialchars($profile['alamat'] ?? '') ?></textarea>
                    </div>
