...
<head>
    ...
    <title>Laporan Penyewaan - Ketua Sanggar</title>
...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="laporan.php" class="nav-link active">Laporan Sewa</a>
    ...
    <div class="dashboard-container">
        ...
        <div class="table-section">
            <table class="premium-table" id="tbl-laporan-ks">
                <thead>
                    <tr>
                ...
                <tfoot>
                    ...
                    <?php if ($is_detail_mode): ?>
                        <td colspan="6" style="text-align: right; padding: 1rem; color: var(--text-muted); font-size: 1rem;">Total Nilai Sewa (Lunas) — <?= htmlspecialchars($kategori_filter) ?>:</td>
                        <td style="color: var(--success); font-size: 1.15rem; padding: 1rem;"><?= formatRupiah($total_pendapatan) ?></td>
                    <?php else: ?>
                        <td colspan="8" style="text-align: right; padding: 1rem; color: var(--text-muted); font-size: 1rem;">Total Pendapatan Terverifikasi (Lunas):</td>
                        <td style="color: var(--success); font-size: 1.15rem; padding: 1rem;"><?= formatRupiah($total_pendapatan) ?></td>
                    <?php endif; ?>
                    </tr>
                </tfoot>
    ...
    <script>initPagination(document.getElementById('tbl-laporan-ks'));</script>
    <script>
