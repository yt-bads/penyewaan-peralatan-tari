...
if ($is_detail_mode) {
    ...
    if (count($report_list) > 0) {
        ...
        $html .= '
        <tr>
            <td colspan="7" style="text-align: center; color: #999;">Tidak ada data peralatan kategori ' . $kategori_label . '.</td>
        </tr>';
    }

    $html .= '
        <tr class="total-row">
            <td colspan="6" style="text-align: right; font-size: 11px; padding: 10px;">Total Nilai Sewa (Lunas) — ' . $kategori_label . ':</td>
